...
public class UPlayer {
    ...
    public UPlayer(final Activity activity, final RNUnityModule.UnityPlayerCallback callback) throws ClassNotFoundException, InvocationTargetException, IllegalAccessException, InstantiationException {
        super();
        Class<?> _player = null;
